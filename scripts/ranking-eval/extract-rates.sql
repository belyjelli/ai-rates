...
-- plans/ranking-evaluation-preregistration.md §3 fixes these dates (W2 substituted per §9 on
-- 2026-09-24, to 2026-09-22 to 2026-09-28); do not edit them to peek earlier.
\set QUIET on
COPY (
  WITH legs AS (
    SELECT long_venue_id AS venue_id, long_symbol AS venue_symbol FROM market_pair_candidates
    WHERE run_day BETWEEN DATE '2026-09-14' AND DATE '2026-09-28'
  ...
  WHERE d.day BETWEEN DATE '2026-09-15' AND DATE '2026-09-29'
