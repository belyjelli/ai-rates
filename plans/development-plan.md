...
> - **Shipped 2026-09-12 — `/heatmap`, assets × exchanges.** The screener answers "widest spread for one asset"; nothing answers "where does this asset's funding sit everywhere at once" without opening a page per asset. Rows are assets, columns are exchanges, cells are funding APR, after orbitperpscreener.com/screener.
...
>   - **Built in three slices, riskiest first.** H1 the data foundation, H2 the query/params/`/v1/heatmap`, H3 the page.
