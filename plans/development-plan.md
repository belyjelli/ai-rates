...
> - **Next:** the `/pair/$sym` page — a leg picker plus the result, and an equity curve, which needs a small server-rendered SVG since the site has no chart primitive and the Free plan allows 10 ms CPU.
